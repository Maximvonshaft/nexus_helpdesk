...
`evidence_reference_id` may select a specific in-scope Case Context; when omitted, the server resolves the latest valid active context. There is no client-controlled evidence or review-override boolean.
