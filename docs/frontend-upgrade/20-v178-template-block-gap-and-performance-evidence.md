...
The next PR should continue template-block parity with remaining Operations governance write endpoints or broader Persona runtime analytics after the QA agent appeal workflow lands.
