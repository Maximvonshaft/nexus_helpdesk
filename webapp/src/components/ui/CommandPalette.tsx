...
const actions = [
  ...
  { id: 'webchat', label: '打开 WebChat', keywords: 'webchat 网站聊天 收件箱 客户来信 接管 打开 WebChat 收件箱', to: '/webchat' },
  { id: 'webcall-workbench', label: '打开 WebCall', keywords: 'webcall 语音 来电 接听 ai 建议 handoff 打开 WebCall 工作台', to: '/webcall', access: routeAccess['/webcall'] },
  { id: 'email-workbench', label: '打开 Email', keywords: 'email 邮件 工作台 草稿 回复 发送', to: '/email', access: routeAccess['/email'] },
  { id: 'workspace', label: '进入工单中心', keywords: '工单 回复 客户 闭环 分配 升级 处理工单 / 客户回复', to: '/workspace' },
  { id: 'customer-search', label: '客户 / 运单查询', keywords: '客户 运单 waybill tracking callerid 电话 手机 查单 查询', to: '/customer-search' },
  { id: 'control-tower', label: '打开运营报表 / Control Tower', keywords: 'control tower 主管 治理 sla 队列 公告 rbac 打开 Control Tower', to: '/control-tower', access: routeAccess['/control-tower'] },
  { id: 'qa-training', label: '打开 QA / Training', keywords: 'qa training 质检 培训 知识缺口 scorecard coaching 打开 QA / Training Loop', to: '/qa-training', access: routeAccess['/qa-training'] },
  { id: 'knowledge-studio', label: '打开知识库', keywords: 'knowledge 知识库 检索 发布 回滚 冲突 chunk golden test 打开 Knowledge Studio', to: '/knowledge-studio', access: routeAccess['/knowledge-studio'] },
  { id: 'persona-builder', label: '打开 AI Persona', keywords: 'persona ai 人格 语气 身份 匹配 发布 回滚 simulation resolve preview 打开 AI Persona Builder', to: '/persona-builder', access: routeAccess['/persona-builder'] },
