...
- Kept Persona edit/publish/rollback commands linked to existing `/ai-control`; submit-review, approval/release-window, and dedicated runtime evidence query remain marked `not_implemented`.
