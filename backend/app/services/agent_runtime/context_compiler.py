...
_AGENT_INSTRUCTION = (
    ...
    "next_action='reply', provide customer_reply and use an empty tool_calls list. "
    "For a handoff set next_action='request_handoff', handoff_required=true, provide "
    "a handoff_reason and customer_reply, and use an empty tool_calls list. For a "
    "Tool request set next_action='call_tool', customer_reply=null and provide one "
    "or more tool_calls. Reply in the customer's current language. Never expose "
