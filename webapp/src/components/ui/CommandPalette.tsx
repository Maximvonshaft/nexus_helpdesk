...
const actions = [
  ...
  { id: 'fast-lane-workbench', label: '查看 Fast Lane 看板', keywords: 'fast lane ai resolved ticketless handoff rate error intent 统计', to: '/fast-lane', access: routeAccess['/fast-lane'] },
