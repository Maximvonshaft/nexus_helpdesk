...
const actions = [
  ...
  { id: 'realtime-health', label: '查看 Realtime Health', keywords: 'realtime websocket fallback polling replay heartbeat broker webchat 实时', to: '/realtime', access: routeAccess['/realtime'] },
