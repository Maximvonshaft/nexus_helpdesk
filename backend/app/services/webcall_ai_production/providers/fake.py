...
class FakeSTTProvider(STTProvider):
    ...
    def transcribe(self, audio: bytes, *, language: str | None = None) -> STTResult:
        ...
        return STTResult(text=text or "where is my package", language=language or "en", confidence=100)
...
class FakeTTSProvider(TTSProvider):
    ...
    def synthesize(self, text: str, *, language: str | None = None) -> TTSResult:
        return TTSResult(audio_bytes=text.encode("utf-8"), mime_type="text/plain; charset=utf-8", text=text)
