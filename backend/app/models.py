...
class Ticket(Base):
    ...
    last_ai_update: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    last_runtime_reply_at: Mapped[Optional[datetime]] = mapped_column(UTCDateTime, nullable=True, index=True)
...
class TicketOutboundMessage(Base):
    ...
    body: Mapped[str] = mapped_column(Text)
    origin: Mapped[Optional[str]] = mapped_column(String(80), nullable=True, index=True)
    runtime_trace_id: Mapped[Optional[str]] = mapped_column(String(120), nullable=True, index=True)
    runtime_contract_version: Mapped[Optional[str]] = mapped_column(String(80), nullable=True, index=True)
    runtime_signature: Mapped[Optional[str]] = mapped_column(String(128), nullable=True)
    runtime_contract_payload_json: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    runtime_contract_payload_sha256: Mapped[Optional[str]] = mapped_column(String(64), nullable=True)
    runtime_reply_type: Mapped[Optional[str]] = mapped_column(String(40), nullable=True, index=True)
    safety_status: Mapped[Optional[str]] = mapped_column(String(40), nullable=True, index=True)
