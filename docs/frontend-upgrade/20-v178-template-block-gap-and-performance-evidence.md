...
The next PR should continue template-block parity, with AI Persona Builder / Knowledge Studio lifecycle or remaining Operations governance write endpoints as the next likely cut.
