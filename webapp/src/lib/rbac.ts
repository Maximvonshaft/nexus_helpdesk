...
export const routeAccess = {
  ...
  '/webcall-ai-monitor': { allOf: [CAPABILITIES.runtimeRead] },
...
export const actionAccess = {
  ...
  forceEndWebcallAI: { allOf: [CAPABILITIES.runtimeManage, CAPABILITIES.webcallVoiceEnd] },
...
export const capabilityCatalogMeta: CapabilityMeta[] = [
  ...
  { capability: CAPABILITIES.runtimeRead, label: '查看运行状态', group: '治理配置', description: '查看运行健康、AI 语音监控和审计态势，不执行恢复动作。', risk: 'normal' },
