...
const nav = [
  ...
  { to: '/integration-observability', label: 'Integration 观测', hint: '外部 API 请求、scope 与幂等', access: routeAccess['/integration-observability'] },
...
const navGroups = [
  ...
  { label: '治理与运维', items: ['/runtime', '/integration-observability', '/ai-control', '/control-plane', '/users', '/webcall-ai-demo'] },
]
