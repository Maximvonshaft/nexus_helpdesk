...
const nav = [
  ...
  { to: '/qa-training', label: 'QA / Training', hint: '质检、评分、培训闭环', access: routeAccess['/qa-training'] },
...
const navGroups = [
  ...
  { label: '治理与运维', items: ['/runtime', '/ai-control', '/qa-training', '/control-plane', '/users', '/webcall-ai-demo'] },
]
