"""Public Ticket domain authority.

The private core owns ticket mechanics. This module owns the cross-domain Safe
Effective Closure gate so no API, worker or UI can close a ticket from status or
technical success alone.
"""
