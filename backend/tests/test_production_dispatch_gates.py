...
def _message(channel=SourceChannel.whatsapp, status=MessageStatus.processing):
    return SimpleNamespace(
        ...
        runtime_contract_payload_json=None,
        runtime_contract_payload_sha256=None,
...
def test_process_external_message_provider_disabled_never_calls_provider(monkeypatch):
    ...
    monkeypatch.setattr(message_dispatch, "_dispatch_whatsapp_message", _provider_must_not_run)
    monkeypatch.setattr(message_dispatch, "_dispatch_email_message", _provider_must_not_run)
