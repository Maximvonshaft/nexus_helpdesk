...
def _validate_license_policy(payload: Any, *, today: date) -> int:
...
def validate(
    *,
    ...
    license_exception_count = _validate_license_policy(
        _load(license_policy_path), today=today
    )
        ...
        json.dumps(
            {
                ...
                "license_exception_count": license_exception_count,
            },
            sort_keys=True,
        )
        + "\n",
