...
The next PR should continue template-block parity with Persona runtime evidence query, QA appeal writes, or remaining Operations governance write endpoints as the next likely cut after the Knowledge Studio conflict/golden-test workflow lands.
