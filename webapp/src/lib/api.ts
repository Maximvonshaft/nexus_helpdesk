...
export const api = {
  ...
  cases: (params?: { q?: string; status?: string; priority?: string; assignee_id?: number; team_id?: number; overdue?: boolean; cursor?: string | null; limit?: number }) => {
    ...
    return request<CaseListPage>(`/api/lite/cases?${search.toString()}`)
  },
