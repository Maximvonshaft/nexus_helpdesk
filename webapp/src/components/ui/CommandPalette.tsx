...
const actions = [
  ...
  { id: 'webcall-ai-monitor', label: '查看 WebCall AI Monitor', keywords: 'webcall ai monitor production sessions events health force-end', to: '/webcall-ai-monitor', access: routeAccess['/webcall-ai-monitor'] },
