...
print('external_channel_bridge_enabled=', s.external_channel_bridge_enabled)
print('external_channel_bridge_url=', s.external_channel_bridge_url)
print('external_channel_transport=', s.external_channel_transport)
print('external_channel_deployment_mode=', s.external_channel_deployment_mode)
