...
const actions = [
  ...
  { id: 'webcall-ai-monitor', label: '查看 WebCall AI Monitor', keywords: 'webcall ai monitor sessions events force end health livekit', to: '/webcall-ai-monitor', access: routeAccess['/webcall-ai-monitor'] },
