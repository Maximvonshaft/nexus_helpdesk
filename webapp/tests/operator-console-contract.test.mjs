...
test('overview page consumes real today workbench contract and provides priority entrypoints', () => {
  ...
  assert.match(types, /role_label: string/)
  assert.match(types, /mission: string/)
  ...
  assert.match(overviewRoute, /visible_entrypoints/)
  assert.match(overviewRoute, /Command Center/)
  assert.match(overviewRoute, /交互状态/)
  assert.match(overviewRoute, /unsaved changes/)
  assert.match(overviewRoute, /routeAccess 与后端 RBAC/)
