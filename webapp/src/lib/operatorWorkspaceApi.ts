...
export const operatorWorkspaceApi = {
  ...
  conversationThread: (path: string, init?: RequestInit) => apiRequest<WebchatThread>(path, {
    ...init,
    requireApiPath: true,
    requestIdPrefix: 'workspace',
  }),

  sourceRecord: (path: string, init?: RequestInit) => apiRequest<WorkspaceSourceRecord>(path, {
    ...init,
    requireApiPath: true,
    requestIdPrefix: 'workspace',
  }),
