...
- The sidecar clears `CODEX_API_KEY`, `OPENAI_API_KEY`, `OPENAI_ACCESS_TOKEN`, `CODEX_ACCESS_TOKEN`, and `EXTERNAL_CHANNEL_HOME` when spawning Codex app-server.
- Local Codex/ExternalChannel profiles must not override request-scoped login.
