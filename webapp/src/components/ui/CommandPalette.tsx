...
const actions = [
  ...
  { id: 'integration-observability', label: '查看 Integration Observability', keywords: 'integration request_id idempotency retryable error_code 外部接口 幂等 排障', to: '/integration', access: routeAccess['/integration'] },
