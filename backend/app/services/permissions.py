...
ROLE_CAPABILITIES: dict[UserRole, set[str]] = {
    ...
    UserRole.agent: {
        ...
        CAP_NOTE_WRITE_EXTERNAL, CAP_CUSTOMER_PROFILE_READ, CAP_STATS_READ,
    ...
    UserRole.auditor: {
        ...
        CAP_ATTACHMENT_READ_INTERNAL, CAP_CUSTOMER_PROFILE_READ, CAP_STATS_READ,
    },
}
...
def ensure_can_read_stats(user, db: Session | None = None):
    ensure_capability(user, CAP_STATS_READ, db, message="stats_read_requires_capability")
