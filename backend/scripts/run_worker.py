...
from app.services.observability import configure_logging, record_queue_snapshot, record_worker_poll, record_worker_result  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(description='Run NexusDesk outbound and policy background workers')
