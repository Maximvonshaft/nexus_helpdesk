...
const nav = [
  ...
  { to: '/realtime', label: 'Realtime Health', hint: 'WebSocket、fallback 与 replay', access: routeAccess['/realtime'] },
...
const navGroups = [
  ...
  { label: '治理与运维', items: ['/runtime', '/realtime', '/ai-control', '/control-plane', '/users', '/webcall-ai-demo'] },
]
