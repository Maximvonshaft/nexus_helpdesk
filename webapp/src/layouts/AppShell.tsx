...
const nav = [
  ...
  { to: '/permissions-audit', label: '权限与审计', hint: '能力矩阵与审计差异', access: routeAccess['/permissions-audit'] },
]

const navGroups = [
  { label: '日常处理', items: ['/', '/workspace', '/webchat', '/webcall', '/email', '/bulletins'] },
  { label: '渠道与授权', items: ['/accounts', '/outbound-email', '/provider-credentials'] },
  { label: '治理与运维', items: ['/runtime', '/ai-control', '/control-plane', '/users', '/permissions-audit', '/webcall-ai-demo'] },
]
