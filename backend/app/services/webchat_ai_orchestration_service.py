...
from .webchat_ai_service import AI_AUTHOR_LABEL, process_webchat_ai_reply_job as _run_runtime_reply
...
) -> tuple[WebchatConversation, Ticket, WebchatMessage]:
...
def _audit_runtime_turn_non_blocking(
    ...
    *,
    ...
    except Exception as exc:  # pragma: no cover - audit must never block the reply path
        LOGGER.warning(
