...
export const routeAccess = {
  ...
  '/fast-lane': { allOf: [CAPABILITIES.statsRead] },
...
export const capabilityCatalogMeta: CapabilityMeta[] = [
  ...
  { capability: CAPABILITIES.statsRead, label: '查看运营统计', group: '运营统计', description: '查看 Fast Lane ticketless、AI resolved、handoff 和错误分布。', risk: 'normal' },
