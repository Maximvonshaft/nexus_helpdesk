...
Structured logs must not include raw visitor tokens, secrets, prompts, provider credentials, internal adapter paths, stack traces, or full PII bodies. Use conversation/ticket/message IDs and safe reason codes.
