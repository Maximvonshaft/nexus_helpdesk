...
def build_persona_builder(db: Session, current_user) -> dict[str, Any]:
    ...
    return {
        ...
        "release_lifecycle": [
            ...
            _lifecycle_step("approval", "Approval", "Manager / Admin", "submit-review / approve command", "not_implemented", 0, "/persona-builder", False),
        ...
        "template_blocks": [
            ...
            _template_block("approval", "Approval / Release Window", "submit-review / approve endpoints", "not_implemented", "当前 main 后端没有 PersonaApproval 或 release window command", "/persona-builder"),
        ...
        "facts": {
            ...
            "submit_review_endpoint": "not_implemented",
            "approval_endpoint": "not_implemented",
