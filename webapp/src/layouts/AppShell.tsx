...
const nav = [
  ...
  { to: '/webcall-ai-monitor', label: 'WebCall AI Monitor', hint: 'AI 通话健康、会话与事件', access: routeAccess['/webcall-ai-monitor'] },
...
const navGroups = [
  ...
  { label: '治理与运维', items: ['/runtime', '/ai-control', '/control-plane', '/users', '/webcall-ai-monitor', '/webcall-ai-demo'] },
]
